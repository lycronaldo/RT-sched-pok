...
#define POK_CONFIG_PARTITIONS_SCHEDULER  { POK_SCHED_PREEMPTIVE_PRIORITY, POK_SCHED_RR }
#define POK_CONFIG_SCHEDULING_SLOTS \
    { 20000, 40000, 10000, 10000 }
#define POK_CONFIG_SCHEDULING_MAJOR_FRAME 80000
